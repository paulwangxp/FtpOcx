========================================================================
		ActiveX Control DLL : MDFTPOCX
========================================================================

ControlWizard has created this project for your MDFTPOCX ActiveX Control
...
that make up your MDFTPOCX ActiveX Control DLL.
...
MDFtpOcxCtl.h
	This file contains the declaration of the CMDFtpOcxCtrl C++ class.

MDFtpOcxCtl.cpp
	This file contains the implementation of the CMDFtpOcxCtrl C++ class.

MDFtpOcxPpg.h
	This file contains the declaration of the CMDFtpOcxPropPage C++ class.

MDFtpOcxPpg.cpp
	This file contains the implementation of the CMDFtpOcxPropPage C++ class.

MDFtpOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMDFtpOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MDFtpOcx.rc.
